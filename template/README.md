...
[Freelancer](http://startbootstrap.com/template-overviews/freelancer/) is a one page freelancer about theme for [Bootstrap](http://getbootstrap.com/) created by [Start Bootstrap](http://startbootstrap.com/). This theme features several content sections, a responsive about grid with hover effects, full page about item modals, and a working PHP contact form.
